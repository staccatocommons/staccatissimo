...
public class DefaultAnnotatedMethodContextUnitTest extends
	...
	private DefaultAnnotatedMethodContext context;
	...
	public void setUp() throws Exception {
		...
		context = new DefaultAnnotatedMethodContext(logger);
	}

	/**
	 * Test method for
	 * {@link net.sf.staccato.commons.instrument.internal.DefaultMethodContext#getReturnName()}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testGetReturnName() throws Exception {
		context.setMethod(pool.getMethod(
			...
			"value"));
		assertEquals("$_", context.getReturnName());
	}
