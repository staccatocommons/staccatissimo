...
public class Instrumentation {
	...
	public static void instrumentClasspath(ClassInstrumenter classInstrumenter,
		Directory processDirectory, String extraPath) throws Exception {
		new InstrumentationContext(classInstrumenter, processDirectory, extraPath)
			.doInstrument();
	}
	...
	private static class InstrumentationContext {
		...
		public ClassInstrumenter classInstrumenter;

		private InstrumentationContext(ClassInstrumenter classInstrumenter,
			Directory processDirectory, String extraPath) throws NotFoundException {
		...
		private void processAndWriteClass(File baseDir, File classfile)
			throws Exception {
			CtClass clazz = classPool
				.get(ClassNames.getClassName(baseDir, classfile));
