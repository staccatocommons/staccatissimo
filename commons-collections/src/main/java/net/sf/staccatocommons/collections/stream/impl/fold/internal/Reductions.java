...
public class Reductions {
  ...
  // public static <A, B> Reduction<A, Integer> sumOn(Applicable<A, Integer>
  // function) {
  // return sumOn(function, integer());
  // }

  // public static <A, B> Reduction<A, B> sumOn(Applicable<A, B> function,
  // NumberType<B> numberType) {
  // throw new NotImplementedException();
  // // return from(numberType.zero(), numberType.add().of(function));
  // }

  // public static <A> Reduction<A, A> from(Applicable2<? super A, ? super A, ?
  // extends A> function) {
  ...
  // public static <A, B> Reduction<A, B> from(B initial, Applicable2<? super B,
  // ? super A, ? extends B> function) {
