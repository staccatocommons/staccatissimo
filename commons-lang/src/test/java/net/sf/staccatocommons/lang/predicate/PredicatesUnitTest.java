...
public class PredicatesUnitTest extends JUnit4MockObjectTestCase {
  ...
  public void testAny() throws Exception {
    assertTrue(Predicates.any(Predicates.<Integer> true_(), Compare.lessThan(2), Predicates.equal(5)).eval(5));

    assertTrue(Predicates.any(Predicates.<Integer> false_(), Compare.greaterThan(2), Predicates.equal(10)).eval(5));
  }
  ...
  public void testAll() throws Exception {
    assertFalse(Predicates
      .all(Predicates.<Integer> true_(), Predicates.<Integer> false_(), Predicates.equal(5))
      .eval(5));

    assertTrue(Predicates.all(Predicates.<Integer> true_(), Compare.greaterThan(2), Predicates.equal(5)).eval(5));
  }
